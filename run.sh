...
tmux new-session -d -s BME280 'python3 /home/pi/Lightning_Location_System/BME280.py'

tmux new-session -d -s Condition 'python3 /home/pi/Lightning_Location_System/Condition.py'
